...
/**
 * Servlet implementation class HelpNoticeEnrollServlet
 */
@WebServlet("/enroll.b.no")
public class HelpNoticeEnrollServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HelpNoticeEnrollServlet() {
        super();
