...
/**
 * Servlet implementation class HelpNoticeModifyFormServlet
 */
@WebServlet("/modifyForm.b.no")
public class HelpNoticeModifyFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HelpNoticeModifyFormServlet() {
        super();
