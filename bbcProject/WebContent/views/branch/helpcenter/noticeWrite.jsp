...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container">
						...
						<form enctype="multipart/form-data" action="<%= request.getContextPath() %>/enroll.b.no" method="post">
							...
							<div>
								<table class="notice-table">
									...
									<tr>
										...
										<td><textarea class="notice-content" id="content" name="content"></textarea></td>
									</tr>
								</table>
								
							</div>

							<button type="submit" class="bt-style" id="notice-insert-bt">등록하기</button>
						</form>
	...
	<script>
		...
		//$(function(){
		//	$("#showNotice").on("click", function() {  flag = 1;  });
		//});
