      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container">
            ...
            <h5 id="info-client">추가 요금 항목 <hr id="info-client-hr"></h5>

            <!-- 추가 요금 항목 div -->
            <form>
              <div class="surcharge">
                <div class="charge-name"><i class="fas fa-square">초과시간</i></div>
                ...
                <div class="charge-name"><i class="fas fa-square">사고여부<input type="checkbox"></i></div>
                <table class="table t1">
                  <tr>
                    <th>수리 일수</th>
                    <td><input type="number"></td>
                ...
                <div class="charge-name"><i class="fas fa-square">주유량</i></div>
                <table class="table t1">
                  <tr>
                    <th>출고 시점</th>
                    <td><input type="text" value="800" readonly>Liter</td>
                    <th rowspan="2">주유량 미달</th>
                    <td rowspan="2">--- 원</td>
                  </tr>
                  <tr>
                    <th>반납 시점</th>
                    <td rowspan="3"><input type="number" step="10">Liter</td>
                  </tr>
                </table>
              ...
              <div class="bt-div">
                <button class="bt-style">반납 완료</button>
              </div>
            </form>
        </div>
