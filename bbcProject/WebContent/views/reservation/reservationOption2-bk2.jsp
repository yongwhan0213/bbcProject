...
<body>
	...
	<div class="outer">	
		...
		<div class="option-right">
			...
			<p class="hg-30"></p>
			<label class="option-right-hr">예약완료를 위한 이용자 동의 사항</label>
			<div class="user_agreement">
            	<p>
                	<input type="checkbox" id="agreeNM2" name="agreeChk">
                    <label for="agreeNM2" class="mr15"><span class="icon"></span>예약완료를 위한 이용 동의(필수)</label>
                </p>
                    	...
                    	<ul class="txt_list">
                        	<li class="black f14">대여자격
                            	<ul class="txt_list">
                                    ...
                                    <li class="check f13"><span class="txt_point">차량운전자가 위의 대여자격조건에 맞지 않을 경우 현장에서 차량인수가 불가할 수도 있으니 필히 대여자격을 확인해 주시기 바랍니다.</span></li>
								</ul>
							</li>
                           ...
                           <li class="black f14">결제 조건
                                <ul class="txt_list">
                                    ...
                                    <li class="check f13"><span class="txt_point">사전 연락없이 예약시간까지 지점에 방문하지 않으실 경우, 예약이 취소됩니다.</span></li>
                                </ul>
                           </li>
                        </ul>
                    </div>
