 ...
 * Generated at: 2020-03-23 17:48:52 UTC
...
public final class event_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/branch/helpcenter/../../../views/branch/common/menubar.jsp", Long.valueOf(1584977441731L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int endPage = pi.getEndPage();
      ...
      out.write("\t\t\t\t\t\t\t<button class=\"list-enroll-bt\" id=\"event-enroll-bt\" onclick=\"enrollEvent();\">등록</button>\r\n");
      out.write("\t\t\t\t\t\t\t<a data-toggle=\"modal\" data-target=\"#event-delete-Modal\"><button class=\"list-delete-bt\">삭제</button></a>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<table id=\"event-table\" class=\"table table-bordered\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
 ...
 if(list.isEmpty()) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">조회된 이벤트가 없습니다.</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 for(Event e : list) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print( e.getMemberName() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print( e.getEventStartDate() );
      out.write(' ');
      out.write('-');
      out.write(' ');
      out.print( e.getEventEndDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print( e.getEventReadCnt() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
 } 
      ...
      out.write("\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#th_checkAll\").change(function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"input[name=checkRow]\").prop(\"checked\", $(this).prop(\"checked\"))\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#event-table>tbody>tr>td:not(:first-child)\").click(function(){\r\n");
      out.write("\t\t\t\t\t\t        var eno = $(this).parent().children().eq(2).text();\r\n");
      out.write("\t\t\t\t        \t\tlocation.href=\"");
      out.print( request.getContextPath() );
      out.write("/detail.b.ev?eno=\" + eno;\r\n");
      out.write("\t\t\t\t\t\t    });\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t        function enrollEvent(){\r\n");
      out.write("\t\t\t\t\t        \tlocation.href=\"");
      out.print( request.getContextPath() );
      out.write("/enrollForm.b.ev\";\r\n");
      out.write("\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t        $(\"\")\r\n");
      out.write("\t\t\t\t\t       \r\n");
      ...
      out.write("\t\t\t\t\t\t<form class=\"navbar-form navbar-search\" role=\"search\" action=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-btn\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-search btn-default non-dropmenu\">\r\n");
 ...
 if(currentPage == 1) { 
      ...
      out.write("\t\t\t\t\t\t\t\t<button class=\"page-bt\" onclick=\"location.href='");
      out.print( request.getContextPath() );
      out.write("/event.b.ev?currentPage=");
 ...
 if(currentPage == maxPage) { 
      ...
      out.write("\t\t\t\t\t<a class=\"btn btn-primary\" id=\"delsel\" href=\"javascript:deleteEvent();\">삭제</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
